...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* 文档流布局：侧边栏不固定定位，与右侧区域一起随窗口变化 */}
      <div
        data-slot="sidebar-container"
        className={cn(
          "relative z-10 flex h-full min-h-0 w-full transition-[width] duration-200 ease-in-out",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex h-8 min-h-8 w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,padding] duration-200 ease-linear hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent-active data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-active-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:[&>span:last-child]:hidden [&>span:last-child]:min-w-0 [&>span:last-child]:truncate [&>span:last-child]:whitespace-nowrap [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "flex min-w-0 w-full flex-col gap-1 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex h-8 min-h-8 w-full min-w-0 items-center gap-2 overflow-hidden rounded-md pl-8 pr-2 py-2 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 [&>span:last-child]:min-w-0 [&>span:last-child]:truncate [&>span:last-child]:whitespace-nowrap [&>svg]:size-4 [&>svg]:shrink-0",
        "data-[active=true]:bg-sidebar-accent-active data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-active-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
